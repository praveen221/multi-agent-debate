...
These are this app's own rules, carried across theme changes. Every page and component must work at a 375px-wide viewport.
...
- **Theme**: the app is dark-canvas only per the xAI-derived system above — no light mode, no theme toggle.
